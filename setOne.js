...
const fruit = (x,y) => console.log(`The first parameter is ${x}. The second parameter is ${y}.`)
...
function greeting(firstName, lastName, fullName) {
    fullName(firstName + ` ` + lastName)
   }

// INVOKE 'GREETING FUNCTION' HERE
greeting(`Dean`, `Winchester`, (fullName) => console.log(`Hello, my full name is ${fullName}.`)
)
...
function multiplyingFactory (num1) {
    return (num2) => {
      ...
      console.log(`Can not multiply: ${num1} is smaller then 5`)
      }
    }
  }
